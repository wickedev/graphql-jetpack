...
internal const val PREPEND_EDGE_DIRECTIVE_NAME = "prependEdge"
private val PREPEND_EDGE_DIRECTIVE_DESCRIPTION = """
        (Relay Only)
...
val PREPEND_EDGE_DIRECTIVE_TYPE: GraphQLDirective = GraphQLDirective.newDirective()
    .name(PREPEND_EDGE_DIRECTIVE_NAME)
    .description(PREPEND_EDGE_DIRECTIVE_DESCRIPTION)
