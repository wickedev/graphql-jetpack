...
internal const val APPEND_NODE_DIRECTIVE_NAME = "appendNode"
private val APPEND_NODE_DIRECTIVE_DESCRIPTION = """
        (Relay Only)
...
val APPEND_NODE_DIRECTIVE_TYPE: GraphQLDirective = GraphQLDirective.newDirective()
    .name(APPEND_NODE_DIRECTIVE_NAME)
    .description(APPEND_NODE_DIRECTIVE_DESCRIPTION)
