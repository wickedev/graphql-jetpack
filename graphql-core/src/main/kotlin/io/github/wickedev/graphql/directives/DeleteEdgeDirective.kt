...
internal const val DELETE_EDGE_DIRECTIVE_NAME = "deleteEdge"
private val DELETE_EDGE_DIRECTIVE_DESCRIPTION = """
        (Relay Only)
...
val DELETE_EDGE_DIRECTIVE_TYPE: GraphQLDirective = GraphQLDirective.newDirective()
    .name(DELETE_EDGE_DIRECTIVE_NAME)
    .description(DELETE_EDGE_DIRECTIVE_DESCRIPTION)
